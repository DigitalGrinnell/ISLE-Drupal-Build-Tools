...
The following raw output was captured on MA8660 on the afternoon of Friday, March 8.
...
This is grinnell_installer.sh running Fri Mar  8 20:59:36 UTC 2019.
...
Checked out branch issue-101.                                                                                                                                                                                                 [ok]
...
idu cloned from https://github.com/DigitalGrinnell/idu.git.                                                                                                                                                                   [ok]
Checked out branch master.                                                                                                                                                                                                    [ok]
...
clean_url: true
comment_page: 0
cron_key: U0svLHLG6ChWQoPeKnfXQRCEBNMkPXU6_0FkmqU6G9M
cron_last: 1552079104
css_js_query_string: po2fy8
date_default_timezone: UTC
drupal_all_databases_are_utf8mb4: true
drupal_private_key: Ad0_RkW_Y1cCglrg3bg-aSkSZieGct5n-GluCgectCE
file_temporary_path: /tmp
filter_fallback_format: plain_text
install_profile: standard
install_task: done
install_time: 1552079104
menu_expanded: {  }
menu_masks:
  - 501
  - 493
...
drush_extras was not found.                                                                                                                                                                                                   [warning]
The following projects provide some or all of the extensions not found:                                                                                                                                                       [ok]
drush_extras
Would you like to download them? (y/n): y
Project drush_extras (7.x-3.6) downloaded to /root/.drush/drush_extras.                                                                                                                                                       [success]
drush_extras was not found.                                                                                                                                                                                                   [warning]
...
The following extensions will be enabled: idu
Do you really want to continue? (y/n): y
idu was enabled successfully.                                                                                                                                                                                                 [ok]
...
islandora_solr_base_query was set to "*:*".                                                                                                                                                                                   [success]
...
This is ../custom.d/post-install-apache-script.sh running Fri Mar  8 21:54:30 UTC 2019.
...
Package operations: 34 installs, 0 updates, 0 removals
  ...
  - Installing google/apiclient-services (v0.19): Downloading (100%)         
    Failed to execute unzip -qq  '/var/www/html/sites/all/modules/islandora/islandora_multi_importer/vendor/google/apiclient-services/b3dcbd48e40683ce52a82d5a8dfffd56' -d '/var/www/html/sites/all/modules/islandora/islandora_multi_importer/vendor/composer/8accc82e'

replace /var/www/html/sites/all/modules/islandora/islandora_multi_importer/vendor/composer/8accc82e/googleapis-google-api-php-client-services-430b712/src/Google/Service/BigQueryDataTransfer.php? [y]es, [n]o, [A]ll, [N]one, [r]ename:  NULL
...
NAME=vaf-web                                  # [substitute]
HOST=vaf.grinnell.edu                         # [substitute `vaf-kiosk` for `vaf` here]  
IMAGE="mcfatem/vaf-web"                       # [substitute]
docker container run -d --name ${NAME} /
    ...
    --restart always /
${IMAGThe following extensions will be enabled: islandora_multi_importer
Do you really want to continue? (y/n): y
...
Default Database restored from Manual Backups Directory file isle.localdomain-2019-03-08T14-36-01.mysql in 14 sec. 5722 SQL commands executed.                                                                                [success]
...
This is ../custom.d/post-install-solr-script.sh running Fri Mar  8 22:51:09 UTC 2019.
...
Receiving objects: 100% (125/125), 87.44 KiB | 1.82 MiB/s, done.
